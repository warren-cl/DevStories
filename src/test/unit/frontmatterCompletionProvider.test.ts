...
import { StorySize, Story, StoryTypeConfig } from "../../types/story";
...
describe("frontmatterCompletionProviderUtils", () => {
  ...
  describe("getTypeCompletions", () => {
    ...
    it("should return all five story types", () => {
      const completions = getTypeCompletions(storyTypes);
  ...
  describe("detectDependencyContext", () => {
    it("should detect array item under dependencies", () => {
      const lines = ["---", "dependencies:", "  - DS-001", "  - ", "---"];
  ...
  describe("getAllIdCompletions", () => {
    const stories: Pick<Story, "id" | "title">[] = [{ id: "DS-001", title: "First Story" }];
    const epics: Pick<Epic, "id" | "title">[] = [{ id: "EPIC-001", title: "First Epic" }];
